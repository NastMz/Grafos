...
"}")
        ...
        self.route_label = QtWidgets.QLabel(self.route_info)
        self.route_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.route_label.setObjectName("route_label")
        self.verticalLayout_14.addWidget(self.route_label)
        self.weight_label = QtWidgets.QLabel(self.route_info)
        self.weight_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.weight_label.setObjectName("weight_label")
        self.verticalLayout_14.addWidget(self.weight_label)
